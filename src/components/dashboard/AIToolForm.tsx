...
export const AIToolForm = ({ onSubmit, onCancel, initialData }: AIToolFormProps) => {
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input placeholder="e.g., Text Generation, Image Processing" {...field} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>
                URL for the tool's logo or preview image
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
